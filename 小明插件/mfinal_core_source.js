 ...
 * Created by xiaoymin@foxmail.com on 2016/7/27.
 * mfinal插件:根据json结构,生成页面,达到解放后端开发人员的目的,降低后端对前端开发要求,后端专心开发后台接口等服务程序,
 *            前期以表单元素为主,后期会增加更多页面元素的支持,敬请期待
 * mfinal依赖:目前主要依赖bootstrap css框架、jQuery两大流行核心组件,设计之初想法是降低对各个插件的依赖耦合度,构造的
 *            页面元素使用其他插件也能达到多样化可替换,使得页面效果更加丰富
 * mfinal元素:根据众多元素,构建丰富多彩的页面
 *            editor(富文本插件):富文本插件原打算使用百度的ueditor插件,因公司购买富文本插件强制需要使用,所以这里
 *                   使用ewebeditor插件,使用该插件需要依赖服务器环境,并且部署上线需要授权,否则无法使用.
 *            text(基本文本框):文本域,文本域是很强大的一种表单元素,mfinal目前只要支持以下几种数据类型的文本域
 *                              normal:常规文本域,无任务效果
 ...
 * 2016-7-29:构造mfinal插件类基础架构,定义元素基本架构
 * 2016-7-30:添加setBaseElements、getAllElements等方法
 * 2016-7-31:添加addButton,submit等方法实现,表单校验,提交表单，表单校验这里使用layer插件来做提示
 * 2016-8-01:添加list模板页实现,添加datagrid组件,实现删除event
 * 2016-8-02:实现添加、编辑功能
 * ,添加文件上传fileupload组件
 * 2016-8-03:实现页码跳转、参数传递问题
 * 2016-8-04:删除页码跳转判断,参数undefined问题,重构resetPageCompents()方法
 * 2016-8-10:实现radioGroup、checkboxGroup组件远程加载数据初始化
 * 2016-8-11:实现图集上传组件images
 * 2016-8-15:多表关联查询接口实现
 * 2016-8-16:百度地图拾取经纬度坐标组件BMap实现
 * 2016-10-11：百度地图初始化打点
 * 表单解析器
 */
(function($){
     ...
     * 初始化
     */
    mfinal.prototype.init=function(){
        console.time("控制台计时器init");
        console.profile('mfinal性能分析器init');
        var $that=this;
        //try{
            layer.load();
     ...
     * 表单初始化赋值
     */
    mfinal.prototype.initializedForm=function () {
     ...
     * @param target
     */
    mfinal.prototype.initImagesElement=function (json, target,params) {
     ...
     * @param obj
     */
    mfinal.prototype.setBaseElementsValue=function (obj) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //获取所有表单元素
     ...
     */
    mfinal.prototype.setBMapValue=function (json, target, obj) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param obj
     */
    mfinal.prototype.setFileUploadValue=function (json, target, obj) {
     ...
     * @param obj
     */
    mfinal.prototype.setTextValue=function (json, target, obj) {
        //赋值
     ...
     * @param obj 值对象
     */
    mfinal.prototype.setEditorValue=function (json, target, obj) {
     ...
     * @param obj
     */
    mfinal.prototype.setSelectValue=function (json, target, obj) {
        var value=obj[json.meta_column];
        if(value!=null&&value!=""){
            $(target).val(obj[json.meta_column]);
        }
     ...
     * @param obj
     */
    mfinal.prototype.setTextareaValue=function (json, target, obj) {
        $(target).val(obj[json.meta_column]);
    }
     ...
     * @param obj
     */
    mfinal.prototype.setRadioGroupValue=function (json, target, obj) {
     ...
     * @param obj
     */
    mfinal.prototype.setCheckboxGroupValue=function (json, target, obj) {
     ...
     * @param parent
     */
    mfinal.prototype.createTemplatePages=function (obj, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param parent
     */
    mfinal.prototype.createTemplateForm=function (obj, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //初始化创建form表单
        //创建表单对象
     ...
     * @param parent
     */
    mfinal.prototype.createTemplateList=function (obj, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //创建外部div层
        var div=$('<div></div>');
     ...
     * @returns {*|HTMLElement}
     */
    mfinal.prototype.getTemplatePage=function(){
     ...
     * @returns {*}
     */
    mfinal.prototype.getRelQuery=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //默认false
     ...
     * @returns {*}
     */
    mfinal.prototype.getRels=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //默认false
     ...
     */
    mfinal.prototype.setBaseElements=function(json,target){
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //获取验证元素集合
     ...
     */
    mfinal.prototype.setMaps=function (json, mapcomponents) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var maps=$that.maps;
     ...
     */
    mfinal.prototype.getMaps=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        return $that.maps;
    }
     ...
     */
    mfinal.prototype.getMapById=function (id) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var map;
     ...
     * @param target
     */
    mfinal.prototype.setMapElements=function (json, target) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //判断是否是地图元素
     ...
     * 获取地图元素
     */
    mfinal.prototype.getMapElement=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param target
     */
    mfinal.prototype.setServiceElements=function (json, target) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
    ...
    mfinal.prototype.getServiceElements=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param target
     */
    mfinal.prototype.setQueryElements=function (json, target) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 获取所有query查询元素
     */
    mfinal.prototype.getQueryElements=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 获取所有查询按钮的值
     */
    mfinal.prototype.getQueryElementsValue=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param obj
     */
    mfinal.prototype.setConstructs =function (obj) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @returns {*}
     */
    mfinal.prototype.getConstructs=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 获取所有基本表单元素
     */
    mfinal.prototype.getAllFormElements=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 获取待验证表单元素数组
     */
    mfinal.prototype.getValidateElements=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 获取表单的值
     */
    mfinal.prototype.getFormValues=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var eles=$that.getAllFormElements();
        var obj={};
     ...
     * 获取所有service组件值
     */
    mfinal.prototype.getServiceValue=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param target
     */
    mfinal.prototype.getImagesValue=function (obj, target) {
        var value={};
        //获取图片值
     ...
     * @param target
     */
    mfinal.prototype.getFileUploadValue=function (obj, target) {
        return $(target).val();
    }
     ...
     * @param target
     */
    mfinal.prototype.getTextValue=function (obj, target) {
        return $(target).val();
    }
    /**
     * 获取下拉框的值
     ...
     * @param target
     */
    mfinal.prototype.getSelectValue=function (obj, target) {
     ...
     * @param target
     */
    mfinal.prototype.getTextareaValue=function (obj, target) {
        return $(target).val();
    }
     ...
     * @param target
     */
    mfinal.prototype.getEditorValue=function (obj, target) {
        //获取富文本框实例
     ...
     * @param target
     */
    mfinal.prototype.getCheckboxGroupValue=function (obj, target) {
        //复选框是隐藏表单域
        return $(target).val();
    }
     ...
     * @returns {*}
     */
    mfinal.prototype.getRadioGroupValue=function (obj, target) {
        //单选组也是隐藏表单域
        return $(target).val();
    }
     ...
     * @param value 赋值的属性值
     */
    mfinal.prototype.setDataGrid=function (obj, value) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 获取datagrid属性值
     */
    mfinal.prototype.getDataGrid=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * 表单验证
     */
    mfinal.prototype.validate=function () {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var flag=true;
        //获取所有需要表单验证的元素
     ...
     * @param button 结构
     */
    mfinal.prototype.submit=function (button) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param button 结构体
     */
    mfinal.prototype.query=function (button) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //获取datagrid属性
     ...
     * @param parent
     */
    mfinal.prototype.addPlugins=function (plugins,parent) {
     ...
     * @param parent
     */
    mfinal.prototype.addNavs=function (navs, parent) {
     ...
     * @param parent
     */
    mfinal.prototype.addPanel=function(panel,parent){
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //这里创建panel面板
     ...
     * @param parent
     */
    mfinal.prototype.addBMap=function (bmap, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param parent
     */
    mfinal.prototype.addImages=function (images, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //创建图集div
     ...
     * @param parent
     */
    mfinal.prototype.addFileUpload=function (fileupload, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //外部div
        var div=$('<div></div>');
     ...
     * @param parent
     */
    mfinal.prototype.addGrid=function (grid,parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param parent
     */
    mfinal.prototype.addDataGrid=function (datagrid, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //外部div
        var div=$('<div></div>');
     ...
     */
    mfinal.prototype.loadData=function (datagrid,parent,searchParams) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var opts=$that.options;
     ...
     * @param parent
     */
    mfinal.prototype.resetPageComponents=function (datagrid, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //获取datagrid属性
        var dgrid=$that.getDataGrid();
     ...
     * @param data 数据
     */
    mfinal.prototype.addDataGridOperateButtons=function (datagrid, parent,data) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //获取operate 按钮数组
     ...
     * @param data
     */
    mfinal.prototype.addDataGridOperateDetailButton=function (button, parent, data) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var opts=$that.options;
        //创建按钮
     ...
     * @param data
     */
    mfinal.prototype.addDataGridOperateRelationButton=function (button, parent, data) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //创建按钮
        var a=$('<a></a>');
     ...
     * @param data 数据
     */
    mfinal.prototype.addDataGridOperateEditButton=function (button, parent,data) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var opts=$that.options;
        //创建按钮
     ...
     * @param data 数据
     */
    mfinal.prototype.addDataGridOperateDeleteButton=function (button, parent,data) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var opts=$that.options;
        //创建按钮
     ...
     * @param parent
     */
    mfinal.prototype.addDataGridPage=function (datagrid, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //默认不支持分页
     ...
     * @param rows 行
     */
    mfinal.prototype.addGridPlugins=function (plugins,parent,rows) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var percent=100;
     ...
     * @param parent
     */
    mfinal.prototype.addButton=function (button, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param parent
     */
    mfinal.prototype.addButtonGroup=function (bg, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //操作按钮组
        var div=$('<div></div>');
     ...
     * @param parent
     */
    mfinal.prototype.addQueryButton=function (button, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param parent
     */
    mfinal.prototype.addSubmitButton=function (button, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //按钮有事件动作,这里因为统一,使用event_type属性来区分是submit，还是其他
     ...
     * @param parent
     */
    mfinal.prototype.addLinkButton=function (button, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        var opts=$that.options;
     ...
     * @param parent
     */
    mfinal.prototype.addAddButton=function (button, parent) {
        var btn=$('<button></button>');
     ...
     * @param parent
     */
    mfinal.prototype.addText=function (text, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //外部div
        var div=$('<div></div>');
     ...
     * @param parent
     */
    mfinal.prototype.addSelect=function (select, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //外部div
        var div=$('<div></div>');
     ...
     * @param parent
     */
    mfinal.prototype.addTextarea=function (textarea, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //创建label
        var label=$("<label></label>");
     ...
     * @param parent
     */
    mfinal.prototype.addCheckboxGroup=function (cbg, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //创建label
        var label=$("<label></label>");
     ...
     * @param parent
     */
    mfinal.prototype.addRadioGroup=function(radios,parent){
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //创建label
        var label=$("<label></label>");
     ...
     * @param parent
     */
    mfinal.prototype.addEditor=function (obj, parent) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param obj json格式数组
     */
    mfinal.prototype.registerComponentsEvents=function (target_type, target, obj) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        switch (target_type){
            case "editor":
     ...
     * @param target
     */
    mfinal.prototype.registerBMap=function (bmap, target) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //实例化地图对象
     ...
     * @param target
     */
    mfinal.prototype.registerImages=function (images, target) {
        //实例化文件上传
        $(target).images();
    }
     ...
     * @param target
     */
    mfinal.prototype.registerFileUpload=function (fileupload, target) {
        //实例化文件上传
        $(target).fileupload();
    }
     ...
     * @param target
     */
    mfinal.prototype.registerEditor=function (obj, target) {
        setTimeout(function () {
     ...
     * @param target
     */
    mfinal.prototype.registerText=function (obj, target) {
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
        //获取富文本框的类型
     ...
     * @param target
     */
    mfinal.prototype.registerTextToPassword=function (text, target) {
        $(target).passwordText();
    }
    /***
     * 仅仅支持数字和文本
     ...
     * @param target
     */
    mfinal.prototype.registerTextToNumberAlpha=function (text, target) {
        $(target).onlyNumAlpha();
    }
     ...
     * @param target
     */
    mfinal.prototype.registerTextToNumber=function(text,target){
     ...
     * @param target
     */
    mfinal.prototype.registerTextToDecimal=function (text, target) {
     ...
     * @param target
     */
    mfinal.prototype.registerTextToCard=function (text, target) {
     ...
     * @param target
     */
    mfinal.prototype.registerTextToEmail=function (text, target) {
     ...
     */
    mfinal.prototype.registerTextToDateTime=function(text,target){
        //获取datetime的样式格式
     ...
     * @param target
     */
    mfinal.prototype.setRequiredTag=function (json, target) {
     ...
     */
    mfinal.prototype.setComponentsStyle=function(target_type,target,json,className,customerStyle,css_frame){
        //设置当前实例化对象本身变量,this关键字在每个方法时会产生歧义
        var $that=this;
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setPanelStyle=function (json, target, className,customerStyle) {
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setGridStyle=function (json, target, className,customerStyle) {
        if(typeof (className)!="undefined"&&className!=""){
            $(target).addClass(className);
        }
        if(typeof (customerStyle)!="undefined"){
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setTextStyle=function (json, target, className,customerStyle) {
        if(typeof (className)!="undefined"&&className!=""){
            $(target).addClass(className);
        }
        if(typeof (customerStyle)!="undefined"){
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setSelectStyle=function (json, target, className,customerStyle) {
        if(typeof (className)!="undefined"&&className!=""){
            $(target).addClass(className);
        }
        if(typeof (customerStyle)!="undefined"){
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setTextAreaStyle=function (json, target, className,customerStyle) {
        if(typeof (className)!="undefined"&&className!=""){
            $(target).addClass(className);
        }
        if(typeof (customerStyle)!="undefined"){
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setButtonStyle=function (json, target, className,customerStyle) {
        if(typeof (className)!="undefined"&&className!=""){
            $(target).addClass(className);
        }
        if(typeof (customerStyle)!="undefined"){
     ...
     * @param customerStyle 自定义样式,这里接收一个json格式的自定义样式,请参考jQuery.css({})文档
     */
    mfinal.prototype.setDivStyle=function (json, target, className,customerStyle) {
        if(typeof (className)!="undefined"&&className!=""){
            $(target).addClass(className);
        }
        if(typeof (customerStyle)!="undefined"){
